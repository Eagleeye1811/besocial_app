...
class DashboardRepositoryImpl implements DashboardRepository {
  ...
  @override
  Future<DashboardHomeDto> getHome() async {
  ...
  @override
  Future<List<DashboardRecentPostDto>> getRecentPosts({int limit = 5}) async {
  ...
  @override
  Future<List<DashboardTrendingPostDto>> getTrending({int limit = 5}) async {
    final response = await _dio.get<dynamic>(
